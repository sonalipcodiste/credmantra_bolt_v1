...
const WhatsAppButton = () => {
	return (
		<a
			...
			className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 flex items-center justify-center"
